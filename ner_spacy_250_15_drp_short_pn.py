    ...
    with nlp_model.disable_pipes(*other_pipes):       
        ...
        for c_iter in range(n_iter):
            ...
            for batch in batches:
                ...
                nlp_model.update(examples_list, drop=0.15, losses=losses)
...
if __name__ == "__main__":
    ...
    final_model, loss_function_x, loss_function_y = train_ner(train_data_set, n_iter=250)

    print('----------------------------------------', '\n')
    print('Saving To Disk')
    model_save_name = "ner_model_250it_15_drp_short_pn"
